export const ONBOARDING_STEPS = [
    ...
    { id: 6, title: 'Owner Requests', key: 'step.owner_requests', icon: '📝' },
    { id: 7, title: 'Payment', key: 'step.payment', icon: '💳' },
    { id: 8, title: 'Financials', key: 'financials.title', icon: '💰' },
    { id: 9, title: 'Contract', key: 'step.contract', icon: '📄' },
];
