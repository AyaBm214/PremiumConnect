...
const dictionary: Record<string, Record<Language, string>> = {
    ...
    // Financials
    'financials.title': { en: 'Financials & Costs', fr: 'Finances et Coûts' },
    'financials.subtitle': { en: 'Please enter your yearly fixed and variable costs for this property.', fr: 'Veuillez entrer vos coûts fixes et variables annuels pour cette propriété.' },
    'financials.fixed.title': { en: 'Fixed Costs (Yearly)', fr: 'Coûts Fixes (Annuels)' },
    'financials.variable.title': { en: 'Variable Costs (Yearly)', fr: 'Coûts Variables (Annuels)' },
    'financials.fixed.municipal_taxes': { en: 'Municipal Taxes', fr: 'Taxes municipales' },
    'financials.fixed.school_taxes': { en: 'School Taxes', fr: 'Taxes scolaire' },
    'financials.fixed.water_taxes': { en: 'Water Taxes', fr: 'Taxes eau' },
    'financials.fixed.insurance': { en: 'Insurance', fr: 'Assurances' },
    'financials.fixed.advertising': { en: 'Advertising', fr: 'Publicité' },
    'financials.fixed.citq': { en: 'CITQ Fee', fr: 'CITQ' },
    'financials.fixed.admin_fee': { en: 'Admin/Management %', fr: 'Frais d\'administration ou gestion %' },
    'financials.fixed.cleaning_per_stay': { en: 'Cleaning per stay', fr: 'Frais de Ménage par location' },
    'financials.fixed.snow_removal': { en: 'Snow removal / Clearing', fr: 'Déneigement' },
    'financials.fixed.lawn_landscaping': { en: 'Lawn & Landscaping', fr: 'Pelouse, paysagement' },
    'financials.fixed.maintenance_monthly': { en: 'Maintenance per month', fr: 'Entretien par mois/logement' },
    ...
    'financials.variable.appliance_repair': { en: 'Appliance Repairs', fr: 'Réparation appareils électroménagers' },
    'financials.variable.waste_management': { en: 'Waste/Trash', fr: 'Déchets' },
    'financials.variable.electricity': { en: 'Electricity', fr: 'Électricité' },
    'financials.variable.heating_oil_gas': { en: 'Heating (Oil/Gas)', fr: 'Huile ou gaz naturel (Chauffage)' },
    'financials.variable.wood': { en: 'Wood', fr: 'Bois' },
    'financials.variable.pool_spa': { en: 'Pool/SPA Maintenance', fr: 'Piscine ou SPA' },
    'financials.variable.telecom': { en: 'Cable/Internet/Phone', fr: 'Câble/internet/téléphone' },
    'financials.variable.condo_fees': { en: 'Condo Fees', fr: 'Frais de condo par mois' },

    'financials.calculator.title': { en: 'Minimum Price Calculator', fr: 'Calculateur de prix minimum' },
    'financials.calculator.fixed_daily': { en: 'Daily Fixed Costs', fr: 'Coûts fixes journaliers' },
    'financials.calculator.variable_daily': { en: 'Daily Variable Costs', fr: 'Coûts variables journaliers' },
    'financials.calculator.management_fee': { en: 'Management Fee', fr: 'Frais de gestion' },
    'financials.calculator.min_price': { en: 'Minimum Price per Night', fr: 'Prix minimum par nuit' },
    'financials.calculator.breakdown': { en: 'Cost Breakdown', fr: 'Répartition des coûts' },
    'financials.calculator.total_yearly': { en: 'Total Yearly Costs', fr: 'Total des coûts annuels' },
